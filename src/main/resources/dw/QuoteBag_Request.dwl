							...
							ns02#Baggage: {
								...
								ns02#BaggageItems: {
									ns02#BaggageItem: (currPass.Passenger.Baggage.BaggageItems.*BaggageItem map (baggageItem, baggageItemIndex) ->  {
										...
										ns02#Id: baggageItem.Id,
										ns02#InitialWeight: baggageItem.InitialWeight,
										ns02#NativeBaggageId: baggageItem.NativeBaggageId default null,
										ns02#OutOfGauge: baggageItem.OutOfGauge,
										ns02#PassengerId: baggageItem.PassengerId,
										ns02#Printed: baggageItem.Printed,
										ns02#PrintedTime: baggageItem.PrintedTime,
							...
							ns02#Passenger: (i.Reservation.Passengers.*Passenger map (passenger, passIndex) -> {
								...
								ns02#Baggage: {
									...
									ns02#BaggageItems: {
										ns02#BaggageItem: (passenger.Baggage.BaggageItems.*BaggageItem map (baggageItem, baggageItemIndex) ->  {
											ns02#Active: baggageItem.Active  default null,
											ns02#BaggageAllowanceId: baggageItem.BaggageAllowanceId,
											ns02#BaggageItemSubTypeId: baggageItem.BaggageItemSubTypeId,
											ns02#BaggageItemSubTypeName: baggageItem.BaggageItemSubTypeName,
											ns02#BaggageItemType: baggageItem.BaggageItemType,
								...
								ns02#Identity: if (passenger.Identity.LastAPIS != null) {
									ns02#LastAPIS: (passenger.Identity.*LastAPIS map (lasApis, lastApisIndex) -> {	
										...
										ns02#ContactInformation: if (lasApis.ContactInformation.ContactLastName != null) {
											ns02#AddressLine: lasApis.ContactInformation.AddressLine,
											ns02#City: lasApis.ContactInformation.City,
											ns02#CompanyName: lasApis.ContactInformation.CompanyName,
											ns02#ContactFirstName: lasApis.ContactInformation.ContactFirstName,
											ns02#ContactLastName: lasApis.ContactInformation.ContactLastName,
											ns02#ContactTitle: lasApis.ContactInformation.ContactTitle,
											ns02#Country: lasApis.ContactInformation.Country,
											ns02#EmailAddress: lasApis.ContactInformation.EmailAddress,
											ns02#NotificationPreference: lasApis.ContactInformation.NotificationPreference,
											ns02#PostalCode: lasApis.ContactInformation.PostalCode,
											ns02#TelephoneNumber: lasApis.ContactInformation.TelephoneNumber,									
										} else null,
